...
final class Prefs {
    ...
    static final String DEFAULT_PROMPT =
          ...
          + "rozpoznawania, urwane slowa na poczatku i koncu strony, numer strony, zywa pagine "
          + "oraz elementy interfejsu aplikacji.\n\n"
          + "Zadanie: zwroc naturalne polskie tlumaczenie tresci, z zachowaniem podzialu na akapity. "
          + "Popraw w duchu oryginalu oczywiste bledy OCR. Pomin numery stron, naglowki powtarzane "
          + "u gory i dolu strony oraz elementy interfejsu czytnika. Jesli strona zaczyna sie lub "
          + "konczy w polowie zdania, przetlumacz fragment tak jak jest i nie dopisuj brakujacej czesci.\n\n"
